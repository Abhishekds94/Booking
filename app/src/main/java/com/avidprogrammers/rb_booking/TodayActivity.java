...
public class TodayActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#00b248")));
        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#00b248")));

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        //spinner-start
        Spinner spin = (Spinner) findViewById(R.id.today_city);
