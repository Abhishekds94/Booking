...
public class RangeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_range);

        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#2286c3")));

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        //spinner-start
        Spinner spin = (Spinner) findViewById(R.id.range_city);
