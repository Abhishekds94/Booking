...
public class LaterActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_later);
        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#cabf45")));

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        //spinner-start
        Spinner spin = (Spinner) findViewById(R.id.later_city);
